...
Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'TCP Checksum Offload (IPv4)' -RegistryValue '3'
Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'TCP Checksum Offload (IPv6)' -RegistryValue '3'
Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Transmit Buffers' -RegistryValue '2048'
Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'UDP Checksum Offload (IPv4)' -RegistryValue '3'
Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'UDP Checksum Offload (IPv6)' -RegistryValue '3'
